...
class Settings {
	...
	public function enqueue() {
		wp_enqueue_style( 'meta-box-aio', get_stylesheet_directory_uri() . '/libs/meta-box-aio/assets/aio.css', [], '1.23.0' );
		...
		wp_enqueue_script( 'meta-box-aio', get_stylesheet_directory_uri() . '/libs/meta-box-aio/assets/aio.js', ['tippy'], '1.23.0', true );
	}
